...
function LoginForm() {
  ...
  return (
    <div>
      ...
      <h1 className="font-display text-2xl font-bold text-gray-900">Bem-vindo de volta</h1>
      <p className="mt-2 text-sm text-gray-500">Entre na sua conta para acessar o painel.</p>
